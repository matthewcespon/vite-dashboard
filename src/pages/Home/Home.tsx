...
import { BarChart3, Zap, TrendingUp, Shield, BarChart, LineChart, ArrowRight } from 'lucide-react';
    ...
    <div className={`${layoutStyles.flexCol} ${layoutStyles.minHScreen}`}>
      ...
      <main className={layoutStyles.flex1}>
        <section className={styles.heroSection}>
          <div className={`${layoutStyles.container} ${layoutStyles.px4} ${layoutStyles.mdPx6}`}>
            <div
              className={`${layoutStyles.gap6} ${layoutStyles.lgGridCols2} ${layoutStyles.lgGap12} ${layoutStyles.xlGridCols2}`}
            >
              <div className={`${layoutStyles.flexCol} ${layoutStyles.justifyCenter} ${layoutStyles.spaceY4}`}>
                <div className={layoutStyles.spaceY2}>
                  <h1 className={styles.heroTitle}>Transform Your Energy Data into Actionable Insights</h1>
...
<Button 
          ...
          >
            Get Started
              ...
              <div className={`${layoutStyles.flexCol} ${layoutStyles.itemsCenter} ${layoutStyles.justifyCenter}`}>
            ...
            >
              <div className={layoutStyles.spaceY2}>
                ...
                <p className={styles.featuresSubtext}>
                  Our platform provides everything you need to understand and optimize your energy usage
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div className={styles.featureCard}>
                ...
                <div className={layoutStyles.spaceY2}>
                  <h3 className={styles.featureTitle}>Real-time Monitoring</h3>
                  <p className={styles.featureDescription}>
                    Track energy consumption in real-time with intuitive dashboards and alerts
                  </p>
                </div>
              </div>
              <div className={styles.featureCard}>
                ...
                <div className={layoutStyles.spaceY2}>
                  ...
                  <p className={styles.featureDescription}>
                    Gain insights through detailed analysis and predictive modeling of energy patterns
                  </p>
                </div>
              </div>
              <div className={styles.featureCard}>
                ...
                <div className={layoutStyles.spaceY2}>
                  ...
                  <p className={styles.featureDescription}>
                    Identify opportunities to reduce consumption and lower costs with AI-powered recommendations
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className={styles.footer}>
        <p className={styles.footerText}>© {new Date().getFullYear()} EnergyIQ. All rights reserved.</p>
